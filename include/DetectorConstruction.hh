...
public:
  ...
  G4LogicalVolume*   GetLvolTrigger()       {return lvol_trigger;};  
...
private:
  ...
  //trigger
  //
  G4LogicalVolume* lvol_trigger;
   
  //absorber
  //
  G4LogicalVolume* lvol_absorber;
  G4int            nbOfabsorbers;
  G4int            nbOfabsorberlayersIn;
  G4int            nbOfabsorberlayersIn2;
  G4int            nbOfabsorberlayersOut;
  //planes
  //
  G4Material*      planeMat;
  G4double         planeThickness;
  G4LogicalVolume* lvol_plane;
  G4int            nbOfplanes;
