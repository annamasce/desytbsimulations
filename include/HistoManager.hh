...
class HistoManager
{
  ...
  ~HistoManager();
   void Book();
   void WriteTuple();
   void FillNtuple(unsigned long long TriggerIDE, unsigned long long TriggerCounterE,  std::vector<uint32_t> PlaneCodeE, std::vector<uint32_t> PlaneNumberE, std::vector<uint32_t> Board_IPE, std::vector<uint32_t> Board_IDE, std::vector<uint32_t> STiC_IDE, std::vector<uint32_t> Ch_IDE, std::vector<uint32_t> Ch_PositionE, std::vector<unsigned long long> AmpE, std::vector<unsigned long long> Hit_TimeE, std::vector<unsigned long long> Fine_TimeE, std::vector<unsigned long long> Trig_TimeE, std::vector<double> Trig_RealTimeE, std::vector<double> Hit_RealTimeE, std::vector<double> Track_IDE, std::vector<std::string> ParticleIDE, std::vector<double> MassE, std::vector<double> PxE, std::vector<double> PyE, std::vector<double> PzE, std::vector<double> PtE, std::vector<double> ThetaE, std::vector<double> PhiE, std::vector<double> EnergyE, std::vector<double> MomentumE );
  ...
  private:
    ...
    std::vector<std::string> ParticleID;
