...
class Run : public G4Run
{
  ...
  public:
    void SetPrimary(G4ParticleDefinition* particle, G4double energy, G4ThreeVector position);
	
    void SumEvents_1(G4int,G4double,G4double);
    void SumEvents_2(G4double,G4double,G4double);  
    void DetailedLeakage(G4int,G4double);
    unsigned long long GetNev(){return numev;}; 
    virtual void Merge(const G4Run*);
    void EndOfRun();
    unsigned long long numev; 
  private:
    ...
    G4int nbOfModules, nbOfplanes, nbOfLayers, kLayerMax;     
